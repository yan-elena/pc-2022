package pres_detect_thing.consumer;
 ...
 *
 */
public class PresDetectThingHTTPProxy implements PresDetectThingAPI {
	...
	public PresDetectThingHTTPProxy(String thingHost, int thingPort){
